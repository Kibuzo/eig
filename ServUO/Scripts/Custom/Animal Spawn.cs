...
namespace Server
{
	public class AnimalSpawnGenerator
	{
       ...
       6004, 6005, 6006, 6007, 6008, 6009, 6010, 6011, 6012, 13121, 13122, 13123, 13124, 13125, 13126, 13127,
		...
		{
			World.Broadcast( 0x35, true, "Generating Animal spawners, please wait." );
			...
			World.Broadcast( 0x35, true, "Animal spawner generation complete. {0}", ArseneCount );
		}
		...
		public static void Remove() {
		    ...
		    foreach ( Item item in itemList )
			  ...
			  Console.WriteLine("Total Counted Spawner : {0}", AnimalSpawner.Count);
