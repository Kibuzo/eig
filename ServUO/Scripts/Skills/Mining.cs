...
namespace Server.Engines.Harvest
{
    public class Mining : HarvestSystem
    {
        ...
        private Mining()
        {
            ...
            // Every bank holds from 20 to 34 ore
            ...
            // One ore per harvest action, anzi two ores.
            oreAndStone.ConsumedPerHarvest = 2;
            oreAndStone.ConsumedPerFeluccaHarvest = 4;
            ...
            {
                new HarvestResource(00.0, 00.0, 80.0, 1007072, typeof(IronOre), typeof(Granite)),
                new HarvestResource(40.0, 25.0, 105.0, 1007073, typeof(DullCopperOre),	typeof(DullCopperGranite), typeof(DullCopperElemental)),
                new HarvestResource(45.0, 30.0, 110.0, 1007074, typeof(ShadowIronOre),	typeof(ShadowIronGranite), typeof(ShadowIronElemental)),
                new HarvestResource(50.0, 35.0, 115.0, 1007075, typeof(CopperOre), typeof(CopperGranite), typeof(CopperElemental)),
                new HarvestResource(55.0, 40.0, 120.0, 1007076, typeof(BronzeOre), typeof(BronzeGranite), typeof(BronzeElemental)),
                new HarvestResource(60.0, 45.0, 125.0, 1007077, typeof(GoldOre), typeof(GoldGranite), typeof(GoldenElemental)),
                new HarvestResource(65.0, 50.0, 130.0, 1007078, typeof(AgapiteOre), typeof(AgapiteGranite), typeof(AgapiteElemental)),
                new HarvestResource(70.0, 55.0, 135.0, 1007079, typeof(VeriteOre), typeof(VeriteGranite), typeof(VeriteElemental)),
                new HarvestResource(75.0, 60.0, 140.0, 1007080, typeof(ValoriteOre), typeof(ValoriteGranite), typeof(ValoriteElemental))
            };
