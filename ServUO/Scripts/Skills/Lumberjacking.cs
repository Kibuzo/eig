        ...
        private Lumberjacking()
        {
            ...
            if (Core.ML)
            {
                res = new HarvestResource[]
                {
                    ...
                    new HarvestResource(35.0, 25.0, 105.0, 1072541, typeof(OakLog)),
                    new HarvestResource(50.0, 40.0, 120.0, 1072542, typeof(AshLog)),
                    new HarvestResource(65.0, 55.0, 135.0, 1072543, typeof(YewLog)),
