    ...
    public class SBMage : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            public InternalBuyInfo()
            {
                ...
                Add(new GenericBuyInfo(typeof(BlackPearl), 5, 120, 0xF7A, 0));
                Add(new GenericBuyInfo(typeof(Bloodmoss), 5, 120, 0xF7B, 0));
                Add(new GenericBuyInfo(typeof(Garlic), 3, 120, 0xF84, 0));
                Add(new GenericBuyInfo(typeof(Ginseng), 3, 120, 0xF85, 0));
                Add(new GenericBuyInfo(typeof(MandrakeRoot), 3, 120, 0xF86, 0));
                Add(new GenericBuyInfo(typeof(Nightshade), 3, 120, 0xF88, 0));
                Add(new GenericBuyInfo(typeof(SpidersSilk), 3, 120, 0xF8D, 0));
                Add(new GenericBuyInfo(typeof(SulfurousAsh), 3, 120, 0xF8C, 0));
                ...
                */
				...
				List<KeyValuePair<int, int>> Retorno5 = new List<KeyValuePair<int, int>>(); // Array contains scrolls
				Retorno5 = RandomScroll(5, rnd.Next(2,4)); // RandomScroll(Circle, Amount) => Sorts Amount units of circle Circle.
				List<KeyValuePair<int, int>> Retorno6 = new List<KeyValuePair<int, int>>(); // Array contains scrolls
				Retorno6 = RandomScroll(6, rnd.Next(2,4)); // RandomScroll(Circle, Amount) => Sorts Amount units of circle Circle.
				List<KeyValuePair<int, int>> Retorno7 = new List<KeyValuePair<int, int>>(); // Array contains scrolls
				Retorno7 = RandomScroll(7, rnd.Next(1,2)); // RandomScroll(Circle, Amount) => Sorts Amount units of circle Circle.

                foreach (KeyValuePair<int, int> x in Retorno4)
                {
                    Add(new GenericBuyInfo(types[x.Key], 12 + (x.Value / (8 * 4)), rnd.Next(1,10), x.Value, 0, true));
                }
				foreach (KeyValuePair<int, int> x in Retorno5)
				{
					Add(new GenericBuyInfo(types[x.Key], 120 + (x.Value / (8 * 4)), rnd.Next(1,10), x.Value, 0, true));
				}
				foreach (KeyValuePair<int, int> x in Retorno6)
				{
					Add(new GenericBuyInfo(types[x.Key], 1200 + (x.Value / (8 * 4)), rnd.Next(1,10), x.Value, 0, true));
				}
				foreach (KeyValuePair<int, int> x in Retorno7)
				{
					Add(new GenericBuyInfo(types[x.Key], 12000 + (x.Value / (8 * 4)), rnd.Next(1,10), x.Value, 0, true));
				}
